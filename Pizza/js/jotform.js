        ...
        var ready = function () {
            try {
                ...
                if (JotForm.isEncrypted) {
                    displayBadge('https://cdn.jotfor.ms/assets/img/uncategorized/encrypted-form-badge.png', 'encrypted-form-badge', 'Encrypted Form', 'https://www.jotform.com/security', 'encrypted_form', '/#Form-Encryption');
                }
...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
   ...
   */
    ...
    doubleValidationFlag: function () {
        var formID = $$('input[name="formID"]')[0].value;
        var testForms = ["221320445531039", "231306189289160", "222554571493056", "231284217452856", "231058085733052", "231344783597265", 
        "73098607466871", "221565164378057", "223546189204154", "231161808345150", "212788431965871", "230857969486074", "211571050449955", 
        "221730503753247", "230214252097347", "210482862524051", "221595826359165", "221506823452047", "231214898272965", "223182222069349", 
        "220194867294970", "230376692891164", "231180102339040", "230698170113149", "230926178730156", "220785559395067", "231165832315350", 
        "20545011997151", "230047718525152", "222294410753149", "222774735372058", "230186081710044", "202165384940657"];
        var excludedForms = [];
    ...
    isInputAlwaysHidden: function (input) {
        ...
        return cont.hasClassName('always-hidden') || cont.hasClassName('form-field-hidden');
    },
    /**
            ...
            form.observe('submit', function (e) {
                try {
                    ...
                    if (!JotForm.validateAll(form)) {
                        ...
                        if (JotForm.doubleValidationFlag()) { //double validation log
                            var allSections = document.querySelectorAll('ul.form-section:not([id^="section_"])');
                            ...
                            if (allSections.length > 1 && window.FORM_MODE !== 'cardform') {
                                ...
                                for (var i = 0; i < erroredLines.length; i++) {
                                    ...
                                    unvalidFields.push({ id: formLine.id, type: formLine.getAttribute('data-type')})
                                }
